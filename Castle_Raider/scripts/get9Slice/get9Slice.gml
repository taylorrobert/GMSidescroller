...
if (botmid == SOLID and midright == SOLID) return G_9SLICE_TOPLEFT;
if (botmid == SOLID and midright == SOLID) return G_9SLICE_TOPMID;
if (botmid == SOLID and midright == SOLID) return G_9SLICE_TOPRIGHT;

if (botmid == SOLID and midright == SOLID) return G_9SLICE_MIDLEFT;
if (botmid == SOLID and midright == SOLID) return G_9SLICE_CENTER;
if (botmid == SOLID and midright == SOLID) return G_9SLICE_MIDRIGHT;

if (botmid == SOLID and midright == SOLID) return G_9SLICE_BOTTOMLEFT;
if (botmid == SOLID and midright == SOLID) return G_9SLICE_BOTTOMMID;
if (botmid == SOLID and midright == SOLID) return G_9SLICE_BOTTOMRIGHT;
